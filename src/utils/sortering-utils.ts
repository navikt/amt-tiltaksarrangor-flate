...
export const finnNesteSortering = (
  sortKey: string | undefined,
  prevSort: Sortering | undefined
): Sortering | undefined => {
  if (!sortKey) {
    return undefined
  }
...
const finnNesteSorteringRetning = (
  retning: SorteringRetning | undefined
): SorteringRetning | undefined => {
  switch (retning) {
    case 'ascending':
      return 'descending'
    case 'descending':
