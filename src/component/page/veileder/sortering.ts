...
export const sorterVeiledersDeltakere = (deltakere: VeiledersDeltaker[], sortering: Sortering | undefined): VeiledersDeltaker[] => {
	if (!sortering) {
...
const sorterStatusEndringDesc = (deltakere: VeiledersDeltaker[]): VeiledersDeltaker[] => {
