...
export const AdressebeskyttetModal = ({ open, handleCloseModal, handleConfrimed }: Props): React.ReactElement<Props> => {
	...
	return (
		<Modal open={open} header={{ heading: 'Obs: Adressebeskyttet', icon: <ExclamationmarkTriangleIcon aria-hidden />, }} onClose={handleCloseModal}>
			<Modal.Body>
				<BodyLong spacing>
					Denne personen har beskyttet adresse. Vær oppmerksom på at når du klikker deg videre så logger vi navnet ditt og tidspunktet.
				</BodyLong>
				<ConfirmationPanel
					checked={confirmed}
