import { ChevronDownIcon, ChevronUpIcon, EnvelopeClosedIcon, PhoneIcon } from '@navikt/aksel-icons'
...
export const DeltakerDetaljerHeader = (props: BrukerPaaTiltakHeaderProps): React.ReactElement => {
	const { deltakerlisteId, fornavn, mellomnavn, etternavn, fodselsnummer, telefonnummer, epost, adresse, tiltakskode } = props
