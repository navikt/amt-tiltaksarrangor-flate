...
export const DeltakerDetaljerAdresseBeskyttet = ({
  deltaker,
  visTildeling
  ...
  return (
    <div data-testid="bruker-detaljer-page">
      <Heading level="2" size="small" className={styles.deltaker_heading}>
        Adressebeskyttet
      </Heading>
      <div className={styles.detaljer}>
        <section className={styles.section}>
          ...
          <div className={styles.innsokt_adresseBeskyttet}>
            <LabelValue title="Søkt inn på">{soktInnPa}</LabelValue>
            <LabelValue title="Dato">{formatDate(soktInnDato)}</LabelValue>
          </div>
        </section>
