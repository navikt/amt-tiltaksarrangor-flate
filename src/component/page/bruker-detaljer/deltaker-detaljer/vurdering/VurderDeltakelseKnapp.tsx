...
export const VurderDeltakelseKnapp = ({
  deltakerId,
  updateVurdering
}: EndreDeltakelseKnappProps) => {
  const [oppfyllerKraveneModalOpen, setOppfyllerKraveneModalOpen] =
    useState(false)
  const [oppfyllerIkkeKraveneModalOpen, setOppfyllerIkkeKraveneModalOpen] =
    useState(false)
      ...
      <Dropdown>
        ...
        <Dropdown.Menu className={styles.dropdownWrapper}>
          <Dropdown.Menu.List className={styles.dropdown}>
            {vurderingDropDownItem(Vurderingstype.OPPFYLLER_KRAVENE, () =>
              setOppfyllerKraveneModalOpen(true)
            )}
            {vurderingDropDownItem(Vurderingstype.OPPFYLLER_IKKE_KRAVENE, () =>
              setOppfyllerIkkeKraveneModalOpen(true)
            )}
          </Dropdown.Menu.List>
        </Dropdown.Menu>
      </Dropdown>
